...
import { insertPartnerTransactions } from "@/app/_lib/action";
...
export function DataTable<TData, TValue>({
  ...
  const handleCreateTransaction = (
    ...
    startTransition(async () => {
      try {
        const { partnerTransaction } = await insertPartnerTransactions(values);
        onDataChange([partnerTransaction[0], ...data]);

        toast.success("Giao dịch đối tác đã được thêm thành công");
